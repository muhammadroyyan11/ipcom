            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Profil</li>
                 ...
                 <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Edit Profil</h2>
                </div>
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo base_url();?>profildb/proses_ubahsubadmin" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Form</strong> Edit Profil</h3>
                                </div>
