...
class Psyscience extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->science();

		$this->load->view('templates/admin/template');
        $this->load->view('psyscience/psyscience_index_view', $data);
	}
		...
		public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->sciencesub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyscience/psysciencesub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyscience/psyscience_edit_view', $data);
	}
