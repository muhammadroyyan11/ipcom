	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-PROPOSAL</h4>
				<?php
								...
								<div class="box box-info">
									<div class="box-body">
										<div class="form-group">
											<input type="hidden" class="form-control" name="delegasi"
												value="Modus Daring 2">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Judul Proposal
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Email <span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">HP <span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Kategori
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Penulis I
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Penulis II
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Penulis III
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Penulis IV
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="penulis4" value="<?php if (isset($_POST['news_title'])) {
													echo $_POST['news_title'];
												} ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="" class="col-sm-12 control-label">Penulis V
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input class="col-sm-12" style="padding: 7px;" type="file"
													name="abstrak">
											</div>
										</div>
										<div class="form-group">
