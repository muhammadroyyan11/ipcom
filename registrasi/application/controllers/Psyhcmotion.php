...
class Psyhcmotion extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psyintervention/psyhcmotion_index_view', $data);
	}
public function sub()
	{
		$data['setting'] = $this->Model_common->get_setting_data();

		$data['testimonial'] = $this->PsypaperModel->hcmotionsub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyintervention/psyhcmotionsub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyintervention/psyhcmotion_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psyintervention/psyhcmotionsub_edit_view', $data);
	}
