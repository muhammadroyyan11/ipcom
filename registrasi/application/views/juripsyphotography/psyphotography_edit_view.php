		...
		<div class="col-md-12">
			...
			<div class="box box-info">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Judul Photography <span>*</span></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Link to Google Drive <span>*</span></label>
						<div class="col-sm-4">
							<input type="text" class="form-control" name="softcopy" value="<?php echo $testimonial['softcopy']; ?>">
						</div>
					</div>
