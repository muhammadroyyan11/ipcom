...
class Psypreach extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psypreach/psypreach_index_view', $data);
	}
		...
		public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->preachsub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psypreach/psypreachsub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psypreach/psypreach_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psypreach/psypreachsub_edit_view', $data);
	}
