...
<div class="banner-slider"
    style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $event_detail['banner']; ?>)">
    <div class="bg"></div>
    <div class="bannder-table">
        <div class="banner-text">
            <h1>
                <?php echo $event_detail['event_title']; ?>
            </h1>
        </div>
    </div>
</div>
                ...
                <div class="event-detail-content">
                    <div class="event-carousel owl-carousel">
                        <div class="event-photo-item">
                            <img src="<?php echo base_url(); ?>public/uploads/<?php echo $event_detail['photo']; ?>"
                                alt="Event Photo">
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="col-lg-4">
                <div class="event-sidebar sidebar">
                    <div class="sidebar-item">
                        <h3>
                            <?php echo $setting['sidebar_event_heading_upcoming']; ?>
                        </h3>
                        <?php
                        $i = 0;
                            ...
                            <?php if ($today < $row['event_start_date']): ?>
                                <div class="sidebar-recent-item">
                                    <div class="recent-photo">
                                        <a href="<?php echo base_url(); ?>event/view/<?php echo $row['event_id']; ?>"><img
                                                src="<?php echo base_url() . 'public/uploads/' . $row['photo']; ?>"
                                                alt="Event Photo"></a>
                                    </div>
                                    <div class="recent-text">
                                        <a href="<?php echo base_url(); ?>event/view/<?php echo $row['event_id']; ?>">
                    ...
                    <div class="sidebar-item">
                        <h3>
                            <?php echo $setting['sidebar_event_heading_past']; ?>
                        </h3>
                        <?php
                        $i = 0;
                        foreach ($event as $row) {
