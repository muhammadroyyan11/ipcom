		...
		<div class="row">
			<div class="col-12">
				<div class="faq-group headstyle mt-30">
					<h4>FORM REGISTRASI PSY-PAPER</h4>
					<?php
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<input type="hidden" class="form-control" name="delegasi" value="Modus Daring 2">
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								<input type="text" class="form-control" name="jenis" value="Psy-Paper">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-12">
								<select class="form-control select2" name="universitas">
									...
									<option value="Universitas Islam Riau (UIR) Pekanbaru">Universitas Islam Riau (UIR)
										Pekanbaru</option>
									<option value="Universitas Islam Negeri (UIN) Sunan Gunung Djati Bandung">
										Universitas Islam Negeri (UIN) Sunan Gunung Djati Bandung</option>
									...
									<option value="Universitas Islam Negeri Sultan Syarif Kasim (UIN SUSKA) Riau">
										Universitas Islam Negeri Sultan Syarif Kasim (UIN SUSKA) Riau</option>
									<option value="Universitas Muhammadiyah Bandung">Universitas Muhammadiyah Bandung
									</option>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Judul Paper <span>*</span></label>
							<div class="col-sm-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Submit</button></button>
							</div>
						</div>
						<?php echo form_close(); ?>
					</div>
