...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li <?php if($this->uri->segment(2)=="ubahadm"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>PenggunaKasubag/ubahadm"><span class="fa fa-user"></span> Profil</a></li>
            <li <?php if($this->uri->segment(2)=="getPendidikanPegawai"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>PendidikanTU/getPendidikanPegawai"><span class="fa fa-graduation-cap"></span> Pendidikan</a></li>
            <li <?php if($this->uri->segment(2)=="getPekerjaan"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>PekerjaanTU/getPekerjaan"><span class="fa fa-suitcase"></span> Kepangkatan</a></li>
            <li <?php if($this->uri->segment(2)=="getOrganisasi"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>OrganisasiTU/getOrganisasi"><span class="fa fa-group"></span> Organisasi</a></li>
            <li <?php if($this->uri->segment(2)=="getSeminar"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>SeminarTU/getSeminar"><span class="fa fa-plane"></span> Pelatihan/Seminar</a></li>
    ...
    <div class="page-content">
        ...
        <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
            ...
            <li <?php if($this->uri->segment(3)=="pengumuman"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>PengajuanSkripsi/getPengajuanSkripsiAdm"><span class="fa fa-book"></span> Pengajuan Skripsi 
                                <?php $this->db->select('*');
                                    $this->db->where('akademik', '0');
                                    $query = $this->db->get('pengajuanskripsi');
