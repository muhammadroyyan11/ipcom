                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group pull-right">
                                        <a href="https://kimpsi.uii.ac.id/public/uploads/FORMJURIPSY-QIRAAH.xlsx" class="btn btn-danger"><i class="fa fa-download"></i> Export Data</a>
                                    </div>
                                </div>
						...
						<tbody>
							...
							foreach ($testimonial as $row) {
								...
								<tr>
									...
									<td>										
										<a href="<?php echo base_url(); ?>Psyqiraah/editsub/<?php echo $row['reg_id']; ?>" <span class="glyphicon glyphicon-th-list" data-toggle="tooltip" title="Lihat Detail Data"></span></a>
