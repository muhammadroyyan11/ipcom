		...
		<div class="col-md-12">
			...
			<div class="box box-info">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<select class="form-control select" id="reg_jenis" name="reg_universitas" value="<?php echo $testimonial['reg_universitas'] ?>">
							<option <?php if ($testimonial['reg_universitas'] == "") {
								...
								<option <?php if ($testimonial['reg_universitas'] == "Universitas Islam Negeri Sunan Gunung Djati Bandung") {
											echo "selected";
										} ?> value="Universitas Islam Negeri Sunan Gunung Djati Bandung">Universitas Islam Negeri Sunan Gunung Djati Bandung</option>
					...
					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Judul Psy-Preach <span>*</span></label>
						<div class="col-sm-6">
					...
					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Link Youtube <span>*</span></label>
						<div class="col-sm-3">
