	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-TAHFIDZ JUZ 30</h4>
				<?php
					...
					<section class="content">
						<div class="row">
							<div class="col-md-12">
								...
								<?php echo form_open_multipart(base_url() . 'testimonial/tahfidz', array('class' => 'form-horizontal')); ?>
									...
									<div class="box-body">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Jenis Lomba
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="jenis" value="PSY-TAHFIDZ JUZ 30">
											</div>
										</div>
										<div class="form-group">
