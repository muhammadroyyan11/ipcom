...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li class="xn-profile">
                ...
                <div class="profile">
                    ...
                    <div class="profile-data">
                        ...
                        <div class="profile-data-name"><?php echo $this->session->userdata('reg_universitas');?></div>
                        <!-- <div class="xn-title"><?= $users->company ?></div>-->
                    </div>
                    <div class="profile-controls">
                        <a href="<?php echo base_url(); ?>profildb/ubahsubadmin" class="profile-control-left"><span class="fa fa-info"></span></a>
            ...
            <li <?php if($this->uri->segment(1)=="subadmin"){echo 'class="active"';} ?>>
                <a href="<?php echo site_url('subadmin');?>"><span class="fa fa-tachometer"></span> <span class="xn-text">Beranda</span></a>
            </li>
            <li <?php if($this->uri->segment(1)=="registrasi"){echo 'class="active"';} ?>>
                <a href="<?php echo site_url('registrasi');?>"><span class="fa fa-file"></span> <span class="xn-text">Registrasi</span></a>
            </li>

          <!--  <li class="xn-openable"><a href="#"><span class="fa fa-user"></span><span class="xn-text"> Online</span></a>-->
          <!--              <ul>-->
          <!--  <li><a href="<?php echo site_url('SubPsypaper'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Paper</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsyIntervention'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Intervention</span></a></li>-->
          <!--        <li><a href="<?php echo site_url('SubPsyproposal'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Proposal</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsydesign'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Design</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsyinfografis'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Infografis</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsyessay'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Essay</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsymovie'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Movie</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsyvlog'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Vlog</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsyphotography'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Photography</span></a></li>-->
           
          <!--  <li><a href="<?php echo site_url('SubPsypreach'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Preach</span></a></li>-->

          <!--  <li><a href="<?php echo site_url('SubPsyqiraah'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Qiraah</span></a></li>-->
          <!--</ul></li>-->
