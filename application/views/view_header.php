...
<head>
    ...
    <style>
        ...
        .contact-form .btn {
            background: #39af4f;
            /* background: #
                <?php echo $setting['front_end_color']; ?>
            !important;
            */
        }
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12">
                    <div class="logo flex">
                        <!-- <a href="public/uploads/logo.jpeg"></a> -->
                    ...
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <li class="menu-item-has-children"><a href="#">
                                ...
                                <ul>
                                    <li class="menu-item-has-children"><a href="#">MODUS DARING I</a>
                                        <ul>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/debate">PSY-DEBAT</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/science">PSY-CERDAS
                                                    CERMAT</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/tahfidz1">PSY-TAHFIDZ JUZ
                                                    30</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/tahfidz2">PSY-TAHFIDZ 5
                                                    JUZ (JUZ 1-5)</a>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children"><a href="#">MODUS DARING II</a>
                                        <ul>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/essay">PSY-ESAI</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial">PSY-PAPER</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/proposal">PSY-PROPOSAL</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/hcmotion">PSY-HCMOTION</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/cerpen">PSY-CERPEN</a>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children"><a href="#">MODUS DARING III</a>
                                        <ul>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/qiraah">PSY-QIRA'AH</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/preach">PSY-PREACH</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/religi">PSY-LAGU
                                                    RELIGI</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/poster">PSY-POSTER</a>
                                            <li class="menu-item-has-children"><a
                                                    href="<?php echo base_url(); ?>testimonial/photography">PSY-PHOTOGRAPHY</a>

                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children"><a
                                            href="<?php echo base_url(); ?>testimonial/vlog">LIST PESERTA</a>
                                </ul>
                            </li>
                            <li><a href="<?php echo base_url(); ?>team">
                                    <?php echo TEAM; ?>
                                </a></li>
