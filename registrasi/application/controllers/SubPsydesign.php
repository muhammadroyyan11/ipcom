...
class SubPsydesign extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->showdesign();

		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psydesign/psydesign_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psydesign/psydesign_edit_view', $data);
	}
