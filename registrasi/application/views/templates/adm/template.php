...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <?php $staff = $this->session->userdata('id');?>
           <li <?php if($this->uri->segment(3)=="profile"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>penggunadosen/ubahadm"><span class="fa fa-user"></span> Profil</a></li>
           <li <?php if($this->uri->segment(3)=="pendidikan"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>pendidikan/getPendidikanPegawai"><span class="fa fa-graduation-cap"></span> Pendidikan</a></li>
            <li <?php if($this->uri->segment(3)=="profile"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>pekerjaan/getPekerjaan"><span class="fa fa-suitcase"></span> Kepangkatan</a></li>
            <li <?php if($this->uri->segment(3)=="profile"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>organisasi/getOrganisasi"><span class="fa fa-group"></span> Organisasi</a></li>
            <li <?php if($this->uri->segment(3)=="profile"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>seminar/getSeminar"><span class="fa fa-plane"></span> Pelatihan/Seminar</a></li>
