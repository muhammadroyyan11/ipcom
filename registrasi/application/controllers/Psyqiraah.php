...
class Psyqiraah extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psyqiraah/psyqiraah_index_view', $data);
	}
	public function sub()
	{
		$data['setting'] = $this->Model_common->get_setting_data();

		$data['testimonial'] = $this->PsypaperModel->qiraahsub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyqiraah/psyqiraahsub_index_view', $data);
	}
	public function add()
	{
		$data['setting'] = $this->Model_common->get_setting_data();
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyqiraah/psyqiraah_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psyqiraah/psyqiraahsub_edit_view', $data);
	}
