	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-POSTER</h4>
				<?php
									...
									<div class="box-body">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Jenis Lomba
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="jenis" value="Psy-Poster">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Judul Poster
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="judul"
													value="<?php if (isset($_POST['news_title'])) {
