						...
						<tbody>
							...
							foreach ($testimonial as $row) {
								...
								<tr>
									...
									<td>										
										<a href="<?php echo base_url(); ?>Psyhcmotion/edit/<?php echo $row['reg_id']; ?>" <span class="glyphicon glyphicon-th-list" data-toggle="tooltip" title="Lihat Detail Data"></span></a>
