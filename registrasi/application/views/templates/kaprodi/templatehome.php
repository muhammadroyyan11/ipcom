    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li <?php if($this->uri->segment(2)==""){echo 'class="active"';} ?>>
                <a href="<?php echo site_url('kaprodi');?>"><span class="fa fa-tachometer"></span> <span class="xn-text">Beranda</span></a>
            </li>
            <li <?php if($this->uri->segment(3)=="profile"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>PenggunaKaprodi/ubahadm"><span class="fa fa-user"></span> Profil</a></li>
           <li <?php if($this->uri->segment(3)=="download"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>PengajuanSkripsi/getPengajuanSkripsiProdi"><span class="fa fa-code"></span> Pengajuan Skripsi</a>
            ...
            <li <?php if($this->uri->segment(3)=="download"){echo 'class="active"';} ?>><a href="<?php echo site_url(); ?>KunjunganMahasiswa/getKunjunganMahasiswaKaprodi"><span class="fa fa-desktop"></span> Kunjungan Mahasiswa</a></li>
