...
class Psyproposal extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psyproposal/psyproposal_index_view', $data);
	}
		...
		public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->proposalsub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyproposal/psyproposalsub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyproposal/psyproposal_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psyproposal/psyproposalsub_edit_view', $data);
	}
