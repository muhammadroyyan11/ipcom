...
<?php endif; ?>
<!--Blog-Area End-->
<div class="gallery-page pt_60">
    <div class="container">
        <div class="row">
            <div class="gallery-photo col-lg-6 mt_30">

                <div class="gallery-photo">
                    <div>
                        <p style="text-align:center;">
                        <img src="<?= base_url();?>public/uploads/DekanPsikologi.jpg">
                        </p>
                        
                            <h5 align="center">
                                Dr. Agus Abdul Rahman, MPsi., Psikolog Dekan Fakultas Psikologi UIN Sunan Gunung Djati Bandung
                            </h5>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mt_30">
                <div class="about-content">
                    <div class="headline-left">
                        <h2>
                            <span>IPCOM-IV</span>Islamic Psychology Competition IV
                        </h2>
                    </div>
                    <p align="justify">Assalamualaikum wa rahmatullahi wa barakatuh,</p>
                    <p align="justify">Innal hamda lillah wa sholatu wa salamu ‘ala rasulillah, segala puji bagi Allah Rabb semesta raya, shalawat dan salam penghormatan bagi Rasulullah, Nabi Muhammad SAW panutan bagi kita semua.</p>
                    <p align="justify">Pada kesempatan ini, saya menyampaikan ucapan selamat khususnya kepada para panitia yang telah menyusun sampai menyelenggarakan IPCOM IV tahun 2023 dan umumnya pada semua civitas akademik yang mengikuti rangkaian kegiatannya. Semoga keberhasilan penyelenggaraan ini akan lebih bermakna suka cita dengan tercapainya tujuan-tujuan mulia IPCOM IV tahun 2023.</p>
                    <p align="justify">Petunjuk Teknis merupakan acuan dan pedoman bagi semua peserta agar dapat mengikuti IPCOM dengan baik dan mencapai hasil yang maksimal. Oleh karena itu saya sangat berharap semua civitas dapat memahami isi Pedoman Pelaksanaan dan Petunjuk Teknis ini sehingga semua pihak memiliki pemahaman yang sama terhadap setiap perlombaan baik dari sisi tujuan dan aturannya.</p>
                    <p align="justify">Selamat berlomba, jadikan kegiatan ini sebagai wahana untuk menggali dan mengeksplorasi minat bakat serta sebagai pengalaman berharga yang menjadi bekal sehingga setiap individu mendapatkan ibrah yang positif. Semoga IPCOM ini menjadi amalan yang pahalanya besar, menginspirasi dalam mengembangkan syi’ar Islam dan semoga Allah SWT meridhai ikhtiar kita semua, Aamiin.</p>
                    <p align="justify">Terima kasih kepada semua panitia dan para peserta.</p>
                    <p align="justify">Wassalamualaikum wa rahmatullahi wa barakatuh.</p>
