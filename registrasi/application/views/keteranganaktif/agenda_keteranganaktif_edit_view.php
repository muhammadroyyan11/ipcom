            ...
            <ul class="breadcrumb">
                ...
                <div class="page-content-wrap">
                  ...
                  <?= showMessage() ?>
                    <div class="row">
                        <div class="col-md-12">
                           <form class="form-horizontal" method="post" action="<?php echo base_url();?>KeteranganAktif/updatedataagenda" enctype="multipart/form-data">
                             ...
                             <div class="panel panel-default">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group has-feedback ">
                                        <?= form_label('Keperluan 2', 'keperluan2', ['class' => 'col-md-3 col-xs-12 control-label']) ?>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" id="keperluan2" name="keperluan2" value = "<?php echo $keteranganaktif->keperluan2; ?>" />
                                            </div>
                                            <span class="help-block"></span>
                                        </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group has-feedback ">
                                        <?= form_label('Keperluan 3', 'keperluan3', ['class' => 'col-md-3 col-xs-12 control-label']) ?>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" id="keperluan3" name="keperluan3" value = "<?php echo $keteranganaktif->keperluan3; ?>" />
                                            </div>
                                            <span class="help-block"></span>
                                        </div>
                                        </div>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <select class="form-control select" id="agenda" name="agenda" value="<?php echo $keteranganaktif->agenda ?>">
                                                <option <?php if ($keteranganaktif->agenda=="") {echo "selected";}?> value="">-- Pilih --</option>
                                                <option <?php if ($keteranganaktif->agenda=="1") {echo "selected";}?> value="1">Agenda</option>
                                                <option <?php if ($keteranganaktif->agenda=="0") {echo "selected";}?> value="0">Proses</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
