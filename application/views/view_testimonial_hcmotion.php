	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-HCMOTION</h4>
				<?php
									...
									<div class="box-body">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Jenis Lomba
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="jenis" value="Psy-HCMotion">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Judul HCMotion
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Penulis I
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Penulis II
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Penulis III
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Penulis IV
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Penulis V
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<button type="submit" class="btn btn-success pull-left" name="form1">Submit</button> <br>
											</div>
										</div>
										<?php echo form_close(); ?>
									</div>
