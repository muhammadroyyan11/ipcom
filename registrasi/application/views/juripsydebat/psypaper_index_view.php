<ul class="breadcrumb">
                    ...
                    <li class="active">Psy-Debat</li>
                </ul>
                <!-- END BREADCRUMB -->
                <!-- PAGE TITLE -->
                <div class="page-title">
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Psy-Debat</h2>
                </div>
                <!-- END PAGE TITLE -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Data Psy-Debat</h3>
						...
						<tbody>
							...
							foreach ($testimonial as $row) {
								...
								<tr>
									...
									<td>										
										<a href="<?php echo base_url(); ?>JuriPsydebat/edit/<?php echo $row['reg_id']; ?>" <span class="glyphicon glyphicon-th-list" data-toggle="tooltip" title="Lihat Detail Data"></span></a>
