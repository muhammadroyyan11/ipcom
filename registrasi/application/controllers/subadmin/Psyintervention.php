...
class Psyintervention extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psyintervention/psyintervention_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('Psyintervention/Psyintervention_edit_view', $data);
	}
