...
class Testimonial extends CI_Controller
{
	...
	public function add()
	{
		...
		if (isset($_POST['form1'])) {
			...
			if ($valid == 1) {
				...
				redirect(base_url() . 'testimonial/' . $_POST['currentUri'] . '');
			}
		} else {
	...
	public function addonsite() //sini
	{
		$data['setting'] = $this->Model_common->get_setting_data();
