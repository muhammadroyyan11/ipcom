...
class Peserta extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->peserta();

		$this->load->view('templates/admin/template');
        $this->load->view('peserta/peserta_index_view', $data);
	}
	...
	public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->pesertasub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('peserta/pesertasub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('peserta/pesertasub_edit_view', $data);
	}
