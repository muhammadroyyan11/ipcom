	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-PUISI</h4>
				<?php
								...
								<div class="box box-info">
									<div class="box-body">
										<div class="form-group">
											...
											<input type="hidden" class="form-control" name="delegasi" value="Online">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" name="jenis" value="Psy-Puisi">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Judul Puisi <span>*</span></label>
											<div class="col-sm-6">
