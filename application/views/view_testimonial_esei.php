				...
				<div class="box box-info">
					<div class="box-body">
					    <div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" name="delegasi" value="Modus Daring 2" disabled>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Jenis Lomba <span>*</span></label>
							<div class="col-sm-3">
								<input type="text" class="form-control" name="jenis" value="Psy-Paper" disabled>
				        ...
				        <div class="form-group">
				            <label for="" class="col-sm-2 control-label">Soft Copy Paper *</label>
				            <div class="col-sm-6" style="padding-top:6px;">
