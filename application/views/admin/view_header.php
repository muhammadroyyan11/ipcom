	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php echo base_url(); ?>admin/dashboard" class="logo">
				<span class="logo-lg">Kimpsi</span>
			</a>
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<?php if ($this->session->userdata('photo') == ''): ?>
									<img src="<?php echo base_url(); ?>public/img/no-photo.jpg" class="user-image"
										alt="user photo">
								<?php else: ?>
									<img src="<?php echo base_url(); ?>public/uploads/<?php echo $this->session->userdata('photo'); ?>"
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<?php if ($this->session->userdata('role') == 'Admin'): ?>
						...
						<li
							class="treeview <?php if (($class_name == 'category') || ($class_name == 'news') || ($class_name == 'comment')) {
								echo 'active';
							} ?>">
							<a href="#">
							...
							<ul class="treeview-menu">
								<li><a href="<?php echo base_url(); ?>admin/category"><i
											class="fa fa-circle-o"></i>Kategori</a></li>
								<li><a href="<?php echo base_url(); ?>admin/news"><i class="fa fa-circle-o"></i> Berita</a>
								</li>
								<li><a href="<?php echo base_url(); ?>admin/comment"><i class="fa fa-circle-o"></i>
										Komentar</a></li>
							</ul>
						</li>
						...
						<li class="treeview <?php if (($class_name == 'event')) {
							...
							<a href="<?php echo base_url(); ?>admin/event">
								<i class="fa fa-calendar"></i> <span>Jenis Lomba</span>
							</a>
						</li>
						...
						<li class="treeview <?php if (($class_name == 'subscriber')) {
							...
							<ul class="treeview-menu">
								<li><a href="<?php echo base_url(); ?>admin/subscriber"><i class="fa fa-circle-o"></i>All
										Subscribers</a></li>
								<li><a href="<?php echo base_url(); ?>admin/subscriber/send_email"><i
											class="fa fa-circle-o"></i>Email to Subscribers</a></li>
							</ul>
						</li>
						...
						<li
							class="treeview <?php if (($class_name == 'portfolio') || ($class_name == 'portfolio_category')) {
								echo 'active';
							} ?>">
							<a href="#">
							...
							<ul class="treeview-menu">
								<li><a href="<?php echo base_url(); ?>admin/portfolio_category"><i
											class="fa fa-circle-o"></i> Portfolio Category</a></li>
								<li><a href="<?php echo base_url(); ?>admin/portfolio"><i class="fa fa-circle-o"></i>
										Portfolio</a></li>
							</ul>
						</li>
						...
						<li class="treeview <?php if (($class_name == 'faq')) {
							...
							<a href="<?php echo base_url(); ?>admin/faq">
								<i class="fa fa-bolt"></i> <span>Ketentuan Umum</span>
							</a>
						</li>
