...
$route['admin/data-profil/data'] = 'admin/data_profil/data';
$route['admin/profil-user'] = 'admin/profiluser/index';
$route['pengguna/ubah'] ='penggunadosen/ubah';
...
$route['kunjungan-mahasiswa/tu']        = 'KunjunganMahasiswa/getKunjunganMahasiswaAdm';
