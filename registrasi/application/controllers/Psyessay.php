...
class Psyessay extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psyessay/psyessay_index_view', $data);
	}
...
public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->essaysub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyessay/psyessaysub_index_view', $data);
	}
	public function add()
	{
		$data['setting'] = $this->Model_common->get_setting_data();
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyessay/psyessay_edit_view', $data);
	}
...
public function editsub($id)
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psyessay/psyessaysub_edit_view', $data);
	}
