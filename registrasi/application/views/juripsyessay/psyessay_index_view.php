...
<div class="btn-group pull-right">
   <a href="https://ipcom.uir.ac.id/public/uploads/FORMJURIPSY-ESSAY.xlsx" class="btn btn-danger"><i class="fa fa-download"></i> Download Form Penilaian</a>
</div>
                                </div>
						...
						<tbody>
							...
							foreach ($testimonial as $row) {
								...
								<tr>
									...
									<td>										
										<a href="<?php echo base_url(); ?>JuriPsyessay/edit/<?php echo $row['reg_id']; ?>" <span class="glyphicon glyphicon-th-list" data-toggle="tooltip" title="Lihat Detail Data"></span></a>
