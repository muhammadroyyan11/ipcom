...
class Psypuisi extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psypuisi/psypuisi_index_view', $data);
	}
public function sub()
	{
		$data['setting'] = $this->Model_common->get_setting_data();

		$data['testimonial'] = $this->PsypaperModel->puisisub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psypuisi/psypuisisub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psypuisi/psypuisi_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psypuisi/psypuisisub_edit_view', $data);
	}
