        ...
        <div class="row">
            <div class="col-12">
                <div class="faq-group headstyle mt-30">
                    <h4>FORM REGISTRASI PSY-INTERVENTION</h4>
                    <?php
				...
				<div class="box box-info">
					<div class="box-body">
					    <div class="form-group">
							<label for="" class="col-sm-6 control-label">Pengiriman Delegasi <span>*</span></label>
							<div class="col-sm-3">
						...
						<div class="form-group">
							<label for="" class="col-sm-6 control-label">Jenis Lomba <span>*</span></label>
							<div class="col-sm-3">
								<input type="text" class="form-control" name="jenis" value="Psy-Intervention">
							</div>
						</div>
					    <div class="form-group">
				            <label for="" class="col-sm-6 control-label">Universitas <span>*</span></label>
				            <div class="col-sm-6">
				        ...
				        <div class="form-group">
							<label for="" class="col-sm-6 control-label">Judul Intervention <span>*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-6 control-label">HP <span>*</span></label>
							<div class="col-sm-3">
								<input type="text" class="form-control" name="hp" value="<?php if(isset($_POST['news_title'])) {echo $_POST['news_title'];} ?>">
							</div>
						</div>
						<div class="form-group">
				            <label for="" class="col-sm-6 control-label">Kategori <span>*</span></label>
				            <div class="col-sm-3">
				        ...
				        <br><br>
				         <h3>Upload Files</h3>
				        <div class="form-group">
				            <label for="" class="col-sm-6 control-label">Abstrak *</label>
				            <div class="col-sm-6">
				                <input type="file" name="abstrak">
				            </div>
				        </div>
				        <div class="form-group">
				            <label for="" class="col-sm-6 control-label">Surat Pernyataan *</label>
				            <div class="col-sm-6">
				                <input type="file" name="pernyataan">
				            </div>
				        </div>
				        <div class="form-group">
				            <label for="" class="col-sm-6 control-label">KTM *</label>
				            <div class="col-sm-6" style="padding-top:6px;">
				                <input type="file" name="ktm">
				            </div>
				        </div>
				        <div class="form-group">
				            <label for="" class="col-sm-6 control-label">Soft Copy Paper *</label>
				            <div class="col-sm-6" style="padding-top:6px;">
