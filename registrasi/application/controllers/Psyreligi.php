...
class Psyreligi extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->religi();

		$this->load->view('templates/admin/template');
        $this->load->view('psyreligi/psyreligi_index_view', $data);
	}
	...
	public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->religisub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyreligi/psyreligisub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyreligi/psyreligi_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psyreligi/psyreligisub_edit_view', $data);
	}
