...
class SubPsyqiraah extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->showqiraah();

		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psyqiraah/psyqiraah_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psyqiraah/psyqiraah_edit_view', $data);
	}
