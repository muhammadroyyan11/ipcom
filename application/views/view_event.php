...
<div class="banner-slider"
    style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $setting['banner_event']; ?>)">
    <div class="bg"></div>
    <div class="bannder-table">
        <div class="banner-text">
            <h1>
                <?php echo $page_event['event_heading']; ?>
            </h1>
        </div>
    </div>
</div>
                                        ...
                                        <ul>
                                            ...
                                            <li class="event-header-left">
                                                <span><i class="fa fa-map-marker"></i>
                                                    <?php echo ADDRESS ?>:
                                                    <?php echo nl2br($row->event_location); ?>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
