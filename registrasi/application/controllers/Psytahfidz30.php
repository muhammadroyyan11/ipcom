...
class Psytahfidz30 extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psytahfidz30/psytahfidz30_index_view', $data);
	}
		...
		public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->tahfidz30sub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psytahfidz30/psytahfidz30sub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psytahfidz30/psytahfidz30_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psytahfidz30/psytahfidz30sub_edit_view', $data);
	}
