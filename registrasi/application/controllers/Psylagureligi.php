...
class Psylagureligi extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psylagureligi/psylagureligi_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psylagureligi/psylagureligi_edit_view', $data);
	}
