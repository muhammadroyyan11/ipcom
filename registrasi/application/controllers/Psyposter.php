...
class Psyposter extends CI_Controller 
{
	...
	public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->postersub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyposter/psypostersub_index_view', $data);
	}
	public function add()
	{
		$data['setting'] = $this->Model_common->get_setting_data();
...
public function editsub($id)
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psyposter/psypostersub_edit_view', $data);
	}
