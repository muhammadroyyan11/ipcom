...
class Psyinfografis extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psyinfografis/psyinfografis_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyinfografis/psyinfografis_edit_view', $data);
	}
