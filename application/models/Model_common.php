...
class Model_common extends CI_Model
{
    ...
    public function extension_check_pdf($ext)
    {
        if ($ext != 'jpg' && $ext != 'png' && $ext != 'jpeg' && $ext != 'gif' && $ext != 'JPG' && $ext != 'PNG' && $ext != 'JPEG' && $ext != 'GIF' && $ext != 'PDF' && $ext != 'DOC' && $ext != 'DOCX' && $ext != 'pdf' && $ext != 'doc' && $ext != 'docx') {
            return false;
        } else {
            return true;
        }
