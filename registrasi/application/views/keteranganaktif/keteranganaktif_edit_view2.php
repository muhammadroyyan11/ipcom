            ...
            <ul class="breadcrumb">
                ...
                <div class="page-content-wrap">
                  ...
                  <?= showMessage() ?>
                    <div class="row">
                        <div class="col-md-12">
                           <form class="form-horizontal" method="post" action="<?php echo base_url();?>KeteranganAktif/updatedatamahasiswa2" enctype="multipart/form-data">
                             ...
                             <div class="panel panel-default">
                                ...
                                <div class="form-group">
                                        <div class="form-group has-feedback">
                                      <?= form_label('Upload File SPP Terakhir', 'userfile', ['class' => 'col-md-3 col-xs-12 control-label col-sm-2']) ?>
                                        <div class="col-md-6 col-xs-12">
