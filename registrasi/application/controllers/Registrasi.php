...
class Registrasi extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->showregistrasi();

		$this->load->view('templates/subadmin/template');
        $this->load->view('registrasi/registrasi_index_view', $data);
	}

	public function proses_input()
 {

   $result = $this->PsypaperModel->tambah_registrasi();
        if($result) {
  ...
  redirect('registrasi/index'); //mengembalikan halaman setelah berhasil menginputkan data
 }

 public function create()
 {
	 $this->load->view('templates/subadmin/template');
	 $this->load->view('registrasi/registrasi_view');
 }
	public function add()
	{
		$data['setting'] = $this->Model_common->get_setting_data();
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('registrasi/registrasi_edit_view', $data);
	}

	public function update_registrasi(){
		$result = $this->PsypaperModel->update_registrasi();
		if($result) {
	...
	public function download($id){
        ...
        if(!empty($id)){
            ...
            //file path
            $file = './../public/uploads/'.$fileInfo['abstrak'];
...
public function downloadsp($id){
	...
	if(!empty($id)){
		...
		//file path
		$file = './../public/uploads/'.$fileInfo['pernyataan'];
...
public function downloadktm($id){
	...
	if(!empty($id)){
		...
		//file path
		$file = './../public/uploads/'.$fileInfo['ktm'];
 ...
 public function downloadsoft($id){
	...
	if(!empty($id)){
		...
		//file path
		$file = './../public/uploads/'.$fileInfo['softcopy'];
...
public function downloadscreenshoot($id){
	$data = array();
	 //get files from database
	$data['tbl_reg'] = $this->PsypaperModel->getRows();
	//echo "<pre>";
	...
	if(!empty($id)){
		...
		//file path
		$file = './../public/uploads/'.$fileInfo['screenshoot'];
