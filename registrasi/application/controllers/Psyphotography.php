...
class Psyphotography extends CI_Controller 
{
	...
	public function index()
	{
        ...
        $this->load->view('psyphotography/psyphotography_index_view', $data);
	}
	...
	public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->photographysub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psyphotography/psyphotographysub_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psyphotography/psyphotography_edit_view', $data);
	}
...
public function editsub($id)
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psyphotography/psyphotographysub_edit_view', $data);
	}
