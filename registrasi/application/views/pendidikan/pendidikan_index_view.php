...
<!-- PAGE CONTENT WRAPPER -->
                <div class="page-content-wrap">
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="<?php echo site_url('nilai/create');?>" class="btn btn-primary"><i class="fa fa-plus"></i> Penilaian Juri</a>
                                ...
                                <table id="table" class="bordered table">
                                    ...
                                    <?php foreach($nilai as $didik): ?>
                                             <tr>
                                                 ...
                                                 <td><?= $didik->file;?></td>
                                                 <td>
                                                 <a href="<?php echo base_url();?>Nilai/ubah/<?php echo $didik->id; ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                 <a href="<?php echo base_url();?>Nilai/deletedata/<?php echo $didik->id; ?>"><span class="glyphicon glyphicon-trash" onclick ="return confirm('Yakin akan menghapus data ini?')"></span></a>
