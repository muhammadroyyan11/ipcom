    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li class="xn-profile">
                ...
                <div class="profile">
                    ...
                    <div class="profile-controls">
                        <a href="<?php echo base_url(); ?>profildb/ubahadmin" class="profile-control-left"><span class="fa fa-info"></span></a>
            ...
            <li <?php if($this->uri->segment(2)==""){echo 'class="active"';} ?>>
                <a href="<?php echo site_url('admin');?>"><span class="fa fa-tachometer"></span> <span class="xn-text">Beranda</span></a>
            </li>

            <li class="xn-openable"><a href="#"><span class="fa fa-user"></span><span class="xn-text"> Online</span></a>
                        <ul>
            <li><a href="<?php echo site_url('Psypaper'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Paper</span></a></li>

            <li><a href="<?php echo site_url('Psyintervention'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Intervention</span></a></li>
                  <li><a href="<?php echo site_url('Psyproposal'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Proposal</span></a></li>

            <li><a href="<?php echo site_url('Psydesign'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Design</span></a></li>

            <li><a href="<?php echo site_url('Psyinfografis'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Infografis</span></a></li>

            <li><a href="<?php echo site_url('Psyessay'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Essay</span></a></li>

            <li><a href="<?php echo site_url('Psymovie'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Movie</span></a></li>

            <li><a href="<?php echo site_url('Psyvlog'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Vlog</span></a></li>

            <li><a href="<?php echo site_url('Psyphotography'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Photography</span></a></li>
            
            <li><a href="<?php echo site_url('Psypreach'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Preach</span></a></li>

            <li><a href="<?php echo site_url('Psyqiraah'); ?>"><span class="fa fa-user"></span><span class="xn-text">Psy-Qiraah</span></a></li>
            </ul></li>
            <li <?php if($this->uri->segment(2)=="nilai"){echo 'class="active"';} ?>>
                <a href="<?php echo site_url('nilai/getLombaadmin');?>"><span class="fa fa-signal"></span> <span class="xn-text">Penilaian</span></a>
            </li>
            <li><a href="<?php echo site_url('users/index'); ?>"><span class="fa fa-user"></span><span class="xn-text">Management Users</span></a></li>
