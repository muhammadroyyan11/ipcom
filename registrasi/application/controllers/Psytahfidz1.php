...
class Psytahfidz1 extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->tahfidz1();

		$this->load->view('templates/admin/template');
        $this->load->view('psytahfidz1/psytahfidz1_index_view', $data);
	}
		...
		public function sub()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->tahfidz1sub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psytahfidz1/psytahfidz1sub_index_view', $data);
	}
