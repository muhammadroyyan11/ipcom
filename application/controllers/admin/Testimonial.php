...
class Testimonial extends CI_Controller 
{
	...
	public function delete($id) 
	{
        ...
        if($this->Model_testimonial->delete($id)){
            $data['testimonial'] = $this->Model_testimonial->get_testimonial($id);
            if($data['testimonial']) {
                unlink('./public/uploads/'.$data['testimonial']['ktm']);
            }
        }
	...
	{
	    $data['testimonial'] = $this->Model_testimonial->get_testimonial($id);
        // echo '<img src="'.base_url().'./public/uploads/'.$data['testimonial']['ktm'].'">';
        force_download('./public/uploads/'.$data['testimonial']['ktm'], null);
        $success = 'Testimonial is Download successfully';
		$this->session->set_flashdata('success',$success);
        redirect(base_url().'admin/testimonial');
    }
