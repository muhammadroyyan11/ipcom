...
class Psypaper extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->show();

		$this->load->view('templates/admin/template');
        $this->load->view('psypaper/psypaper_index_view', $data);
	}
	public function sub()
	{
		$data['setting'] = $this->Model_common->get_setting_data();

		$data['testimonial'] = $this->PsypaperModel->showsub();

		$this->load->view('templates/subadmin/template');
        $this->load->view('psypaper/psypapersub_index_view', $data);
	}
	...
	public function subadmin()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->showsubadmin();
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/admin/template');
        $this->load->view('psypaper/psypaper_edit_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('psypaper/psypapersub_edit_view', $data);
	}
