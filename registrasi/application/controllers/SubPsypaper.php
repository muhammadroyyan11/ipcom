...
class SubPsypaper extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->showpaper();
		
		$univ = $this->session->userdata('nama');
		// echo "<pre>";
		// echo print_r($univ);
		// echo "</pre>";
		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psypaper/psypaper_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psypaper/psypaper_edit_view', $data);
	}
