	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-PHOTOGRAPHY</h4>
				<?php
					...
					<section class="content">
						<div class="row">
							<div class="col-md-12">
								...
								<?php echo form_open_multipart(base_url() . 'testimonial/addphotography', array('class' => 'form-horizontal')); ?>
									...
									<div class="box-body">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Jenis Lomba
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="jenis" value="Psy-Fotografi">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Judul Fotografi
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Creator V
												<span>*</span></label>
											<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Link Google Drive
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="link" value="<?php if (isset($_POST['news_title'])) {
																												echo $_POST['news_title'];
																											} ?>">
											</div>
										</div>
										...
										<!--<div class="form-group">-->
										<!--    <label for="" class="col-sm-2 control-label">Abstrak *</label>-->
										<!--    <div class="col-sm-6">-->
