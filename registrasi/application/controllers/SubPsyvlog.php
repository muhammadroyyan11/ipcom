...
class SubPsyvlog extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['testimonial'] = $this->PsypaperModel->showvlog();

		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psyvlog/psyvlog_index_view', $data);
	}
	...
	$data['setting'] = $this->Model_common->get_setting_data();
		...
		$this->load->view('templates/subadmin/template');
        $this->load->view('subadmin/psyvlog/psyvlog_edit_view', $data);
	}
