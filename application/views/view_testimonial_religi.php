	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-LAGU RELIGI</h4>
				<?php
									...
									<div class="box-body">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Jenis Lomba
												<span>*</span></label>
											<div class="col-sm-12">
												<input type="text" class="form-control" name="jenis" value="Psy-Lagu Religi">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label for="" class="col-sm-2 control-label">Judul Lagu Religi
												<span>*</span></label>
											<div class="col-sm-12">
