	...
	<div class="row">
		<div class="col-12">
			<div class="contact-form headstyle pt_90">
				<h4>FORM REGISTRASI PSY-DEBAT</h4>
				<?php
								...
								<div class="box box-info">
									<div class="box-body">
										<div class="form-group">
											...
											<div class="col-sm-3 col-md-12">
												<input type="text" class="form-control" name="delegasi" value="Modus Daring 1">
										...
										<div class="form-group">
											<label for="" class="col-sm-3 control-label">Jenis Lomba
												<span>*</span></label>
											<div class="col-sm-3 col-md-12">
												<input type="text" class="form-control" name="jenis" value="Psy-Debat">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-3 col-md-12">
												<input type="text" class="form-control" name="kategori" value="Kelompok">
											</div>
										</div>
										<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-12" style="padding-top:6px;">
											<input type="file" style="padding: 6px; width:100%;" name="ktm">
										</div>
									</div>
									<div class="form-group">
