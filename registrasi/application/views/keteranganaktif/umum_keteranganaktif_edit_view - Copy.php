            ...
            <ul class="breadcrumb">
                ...
                <div class="page-content-wrap">
                  ...
                  <?= showMessage() ?>
                    <div class="row">
                        <div class="col-md-12">
                           <form class="form-horizontal" method="post" action="<?php echo base_url();?>KeteranganAktifTU/updatedata" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <select class="form-control select" id="tu" name="tu" value="<?php echo $keteranganaktif->tu ?>">
                                                <option <?php if ($keteranganaktif->tu=="") {echo "selected";}?> value="">-- Pilih --</option>
                                                <option <?php if ($keteranganaktif->tu=="1") {echo "selected";}?> value="1">Checked</option>
                                                <option <?php if ($keteranganaktif->tu=="0") {echo "selected";}?> value="0">Proses</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
